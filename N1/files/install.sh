...
echo "警告!以下操作将覆盖原始数据，请熟知当前知道在做什么，否则建议放弃操作！"
echo "再次提醒，记得备份您的重要数据!"
echo -ne "将 OpenWrt 写入到当前盒子的 EMMC 请输入 y 敲回车 稍等片刻即可 y/n [n]\b\b"
read yn
case $yn in 
	y|Y) yn='y';;
	*)   yn='n';;
...
echo "恭喜写入完成，请输入 reboot 重启 或输入 poweroff 关机 拔出U盘！开启您的折腾之旅 ^!^"
